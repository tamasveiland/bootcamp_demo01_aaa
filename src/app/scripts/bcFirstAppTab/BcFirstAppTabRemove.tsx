...
export interface IBcFirstAppTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IBcFirstAppTabRemoveProps {

}

/**
 * Implementation of BC-FirstApp Tab remove page
 */
export class BcFirstAppTabRemove  extends TeamsBaseComponent<IBcFirstAppTabRemoveProps, IBcFirstAppTabRemoveState> {
